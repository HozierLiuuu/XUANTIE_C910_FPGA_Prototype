...
spectre_atk_v1_build:
	@cp ./tests/cases/spectre_atk_v1/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=spectre_atk_v1 FILE=spectre_atk_v1 >& spectre_atk_v1.case.log 

spectre_atk_v2_build:
	@cp ./tests/cases/spectre_atk_v2/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=spectre_atk_v2 FILE=spectre_atk_v2 >& spectre_atk_v2.case.log 

spectre_atk_v4_build:
	@cp ./tests/cases/spectre_atk_v4/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=spectre_atk_v4 FILE=spectre_atk_v4 >& spectre_atk_v4.case.log 
spectre_atk_v5_build:
	@cp ./tests/cases/spectre_atk_v5/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=spectre_atk_v5 FILE=spectre_atk_v5 >& spectre_atk_v5.case.log

aes_test_build:
	@cp ./tests/cases/aes_test/* ./work
	@find ./tests/lib/ -maxdepth 1 -type f -exec cp {} ./work/ \; 
	@cp ./tests/lib/clib/* ./work
	@cp ./tests/lib/newlib_wrap/* ./work
	@cd ./work && make -s clean && make -s all CPU_ARCH_FLAG_0=c910  ENDIAN_MODE=little-endian CASENAME=aes_test FILE=aes_test >& aes_test.case.log
